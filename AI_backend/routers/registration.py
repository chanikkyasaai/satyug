...
def api_validate_schedule(student_id: int, course_ids: List[int], db: Session = Depends(get_db)):
    """
...
def api_enroll(enroll_in: EnrollmentCreate, db: Session = Depends(get_db)):
    """
