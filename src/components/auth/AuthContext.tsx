...
export interface AuthContextValue extends AuthState {
  ...
  signup: (params: { email: string; password: string; role?: UserRole }) => Promise<void>
  logout: () => void
}
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const signup = useCallback(async ({ email, password, role }: { email: string; password: string; role?: UserRole }) => {
